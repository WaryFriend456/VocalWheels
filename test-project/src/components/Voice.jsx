...
const SpeechToTextComponent = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div className="card p-5 shadow-lg rounded-lg bg-white w-full max-w-md mx-auto mt-10">
        <div className="card-body text-center">
          <h2 className="mb-4 text-xl font-bold text-gray-700">Speech to Text</h2>
          <p className="mb-4 text-base text-gray-500">Transcript:</p>
          <textarea
            className="form-control block w-full px-3 py-2 rounded-lg border-gray-300 focus:border-gray-700 focus:ring focus:ring-gray-200 focus:ring-opacity-50"
            rows="6"
            readOnly
            value={transcript}
          />
          ...
          <textarea
            ...
            rows="6"
            readOnly
            value={JSON.stringify(expressData)}
          />
          <p className="mt-4 mb-4 text-base text-gray-500">Flask Data:</p>
          <textarea
            className="form-control block w-full px-3 py-2 rounded-lg border-gray-300 focus:border-gray-700 focus:ring focus:ring-gray-200 focus:ring-opacity-50"
            rows="6"
            readOnly
            value={JSON.stringify(flaskData)}
          />
          {loading && (
          ...
          <div className="mt-4 flex justify-center space-x-4">
            <button
              className="py-2 px-4 rounded-lg font-bold text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring focus:ring-gray-200 focus:ring-opacity-50"
